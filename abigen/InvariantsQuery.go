...
// GetIFILBalances is a free data retrieval call binding the contract method 0xd9131be9.
//
// Solidity: function getIFILBalances(address[] holders) view returns(uint256[] out)
func (_InvariantsQuery *InvariantsQueryCaller) GetIFILBalances(opts *bind.CallOpts, holders []common.Address) ([]*big.Int, error) {
	var out []interface{}
	err := _InvariantsQuery.contract.Call(opts, &out, "getIFILBalances", holders)
...
//
// Solidity: function getIFILBalances(address[] holders) view returns(uint256[] out)
func (_InvariantsQuery *InvariantsQuerySession) GetIFILBalances(holders []common.Address) ([]*big.Int, error) {
	return _InvariantsQuery.Contract.GetIFILBalances(&_InvariantsQuery.CallOpts, holders)
}

// GetIFILBalances is a free data retrieval call binding the contract method 0xd9131be9.
//
// Solidity: function getIFILBalances(address[] holders) view returns(uint256[] out)
func (_InvariantsQuery *InvariantsQueryCallerSession) GetIFILBalances(holders []common.Address) ([]*big.Int, error) {
	return _InvariantsQuery.Contract.GetIFILBalances(&_InvariantsQuery.CallOpts, holders)
}
